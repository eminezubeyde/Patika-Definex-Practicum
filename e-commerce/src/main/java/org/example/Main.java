        ...
        while (secim != -1) {
            switch (secim) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    String username = getCustomerUsername(); //  ilk adım hangi kullanıcı olduğunu kullanıcı adıyla alıyoru<.
                    Customer customer = customerService.getByUsername(username);// 2. adım da hangi müşteri olduğunu bulduk.
                    if (customer != null) {
                        ...
                        /**
                         * adrese erişimin iki yolu var .
                         * 1. yol customer üzrinden 'engin adresin .' engin.getadress.
                         * 2.yol adres databaseinden tüm adreslere erişibirimn.
                         */
                    }
                    break;
                case 3:
                ...
                case 5:
                    // 1.  hangi müşteri
                    // 2.  musteri var mı yok mu
                    // 3.  müşterinin sipariş detaylarını yazdır.
